                          ...
                          Padding( 
                            ...
                            child: Text(
                              ...
                              style: FlutterFlowTheme.bodyText1.override(
                               fontFamily: 'Poppins', color: Color(0xFF999999), 
                                ), ), ), 
                               Padding(
                                                      ...
                                                      focusedBorder: OutlinelnputBorder( 
                                                        borderSide: BorderSide( 
                                                          ...
                                                          borderRadius: BorderRadius.only( 
                                                            ...
                                                            style: FlutterFlowTheme.titlel.override( 
                                                              fontFamily: 'Poppins', 
                                                              fontSize: 50, ), 
                                                              textAlign: TextAlign.center,)),), 
                                                              Padding( 
                                                                                           ...
                                                                                           borderSide: BorderSide( 
                                                                                             ...
                                                                                             FFButtonWidget( 
                                                                                               ...
                                                                                               options: FFButtonOptions( 
                                                                                                 ...
                                                                                                 height: 80, 
                                                                                                 color: Color(0xFFC0C0C0), 
                                                                                                 textStyle: FlutterFlowTheme.titlel.override( 
                                                                                                   fontFamily: 'Poppins', 
                                                                                                   color: Color(0xFF61657F), 
                                                                                                   fontSize: 38, ), 
                                                                                                   borderSide: BorderSide( 
  ...
  child: Row( 
    ...
    children: [ 
     ...
     options: FFButtonOptions( 
       ...
       color: Color(0xFFC0C0C0), 
       textStyle: FlutterFlowTheme.titlel.override( 
         fontFamily: 'Poppins', color: Color(0xFF61657F), 
...
fontSize: 38, ), borderSide: BorderSide( color: Colors.transparent, width: 1, ), borderRadius: 12, 
  ...
  width: 80, height: 80, color: Color(0xFFC0C0C0), textStyle: FlutterFlowTheme.title1.override( 
    fontFamily: 'Poppins', color: Color(0xFF61657F), fontSize: 38, ), borderSide: BorderSide( 
